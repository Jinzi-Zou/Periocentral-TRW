...
def seq_binary_sample(ngh_time_prob,ngh_cen_prob, num_neighbor):
    ngh_binomial_prob = ngh_time_prob + ngh_cen_prob
    ngh_binomial_prob /= np.cumsum(ngh_binomial_prob)
    sampled_idx = []
